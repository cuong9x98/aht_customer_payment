 ...
 */
namespace AHT\CustomerPayment\Block\Adminhtml\Group\Edit;
    ...
    protected function _prepareLayout()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'required-entry',
                'required' => true,
                'values' => $this->allPaymentMethod->toOptionArray(),
            ]
        );
        ...
        $payment = $group->load($customerGroup->getId());
        if ($this->_backendSession->getCustomerGroupData()) {
            ...
            $form->addValues(
                [
                    ...
                    'customer_payment'=> $payment->getData('customer_payment'),
